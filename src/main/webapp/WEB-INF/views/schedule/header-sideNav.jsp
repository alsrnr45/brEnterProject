...
<head>
    ...
    <link href="resources/scheduleResources/css/styles.css" rel="stylesheet" />
...
<body class="sb-nav-fixed">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="index.html">BR Enter</a>
        <!-- Sidebar Toggle-->
    ...
    <script src="resources/scheduleResources/js/scripts.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/simple-datatables@latest" crossorigin="anonymous"></script>
    <script src="resources/scheduleResources/js/datatables-simple-demo.js"></script>
</body>
</html>
