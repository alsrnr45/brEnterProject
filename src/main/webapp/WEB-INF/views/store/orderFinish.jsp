...
<style>
	...
	* {font-family: 'Noto Sans KR', sans-serif;}
	...
	/* 스타일 */
	#layoutSidenav_content div{text-align: center;}
	
	#checkIcon{margin-top: 210px; color: rgb(155, 89, 182);}
	#layoutSidenav_content h1{margin: 17px 35px;}
	#layoutSidenav_content a{padding-top: 8px; width: 150px; height: 45px; border-color: rgb(155, 89, 182);}
	
	#layoutSidenav #layoutSidenav_content{min-height:0;}
   ...
   <!-- 상단바 -->
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            <div id="checkIcon"><i class="fas fa-check-circle fa-10x"></i></div>
            <div><h1>구매가 완료되었습니다.</h1></div>
            <div><a class="btn btn-outline-light text-dark">주문내역 보기</a></div>
        </div>
    </div>
