	                  ...
	                  <h6>결재선<button type="button" class="btn btn-outline-secondary btn-sm signOffBtn" data-toggle="modal" data-target="#signOffBtn">결재선 설정</button></h6>
						...
						<table class="tableType02">
							<tr height="35">
								...
								<td width="136" class="signDept1"><input type="text" class="form-control" id="deptName1" name="ApprovalPathList[0].deptName" readonly></td>
								<td width="136" class="signDept2"><input type="text" class="form-control" id="deptName2" name="ApprovalPathList[1].deptName" readonly></td>
								<td width="136" class="signDept3"><input type="text" class="form-control" id="deptName3" name="ApprovalPathList[2].deptName" readonly></td>
								<td width="136" class="signDept4"><input type="text" class="form-control" id="deptName4" name="ApprovalPathList[3].deptName" readonly></td>
							</tr>
							<tr height="35">
		                        <td>${ loginUser.posiName }</td>
								<td><input type="text" class="form-control" id="posiName1" name="ApprovalPathList[0].posiName" readonly></td>
								<td><input type="text" class="form-control" id="posiName2" name="ApprovalPathList[1].posiName" readonly></td>
								<td><input type="text" class="form-control" id="posiName3" name="ApprovalPathList[2].posiName" readonly></td>
								<td><input type="text" class="form-control" id="posiName4" name="ApprovalPathList[3].posiName" readonly></td>
							</tr>
							...
							<tr height="35">
								...
								<td><input type="hidden" id="memNo1" name="ApprovalPathList[0].memNo"></td>
								<td><input type="hidden" id="memNo2" name="ApprovalPathList[1].memNo"></td>
								<td><input type="hidden" id="memNo3" name="ApprovalPathList[2].memNo"></td>
								<td><input type="hidden" id="memNo4" name="ApprovalPathList[3].memNo"></td>
		                     </tr>
		                     <tr height="35">
								<td style="color:royalblue;">${ loginUser.memName }</td>
								<td><input type="text" class="form-control" id="memName1" name="ApprovalPathList[0].memName" readonly></td>
								<td><input type="text" class="form-control" id="memName2" name="ApprovalPathList[1].memName" readonly></td>
								<td><input type="text" class="form-control" id="memName3" name="ApprovalPathList[2].memName" readonly></td>
								<td><input type="text" class="form-control" id="memName4" name="ApprovalPathList[3].memName" readonly></td>
							</tr>
						</table>
						<br>
					</div>
